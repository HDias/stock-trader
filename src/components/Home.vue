<template>
  <div>
    ...
    <v-sheet :elevator="6" class="pa-2" color="primary">
    ...
    <v-sheet :elevator="6" class="pa-2 mt-3" color="success darken-1">
      <v-icon class="white--text mr-3">info</v-icon>
      <span class="headline white--text font-weight-light">
    ...
    <p class="display-1 font-weight-light"><strong>Seu Saldo:</strong>{{ funds }}</p>
  </div>
</template>
